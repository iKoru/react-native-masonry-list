...
class Masonry extends React.PureComponent {
  ...
  UNSAFE_componentWillReceiveProps = nextProps => {
    if (!nextProps.containerWidth && !this.props.containerWidth) {
      ...
      if (nextProps.containerWidth !== this.props.containerWidth || nextProps.columns !== this.props.columns || nextProps.spacing !== this.props.spacing) {
        this.setState({
          layoutDimensions: {
  ...
  render() {
    if (this.props.emptyView && Array.isArray(this.props.images) && this.props.images.length === 0) {
    ...
    return (
      <View
        style={!this.props.containerWidth ? { flex: 1 } : { flex: 1, width: this.props.containerWidth }}
        onLayout={event => {
      ...
      >
        <MasonryList
          ...
          defaultImageDimensions={this.props.defaultImageDimensions}
